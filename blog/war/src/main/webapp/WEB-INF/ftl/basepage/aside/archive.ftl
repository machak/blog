                    ...
                    [#compress]
                        ...
                        <li${liclass}>
                            ...
                            [#if facetvalue.leaf]${facetlabel} (${facetvalue.count})
                                ...
                                [/#if]
                            [#else]
                                <a href="[@hst.link hippobean=facetvalue/]" rel="nofollow"> ${facetlabel}</a> (${facetvalue.count})
                            [/#if]
                        </li>
                        [#if facetvalue_has_next=false && facetvalue_index>4]
                            <li class="more"><a href="#" class="toggle">&raquo; Less</a></li>[/#if]
                    [/#compress]
                [/#list]
            </ul>
        [/#if]
