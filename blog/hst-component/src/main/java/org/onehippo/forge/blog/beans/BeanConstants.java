...
public final class BeanConstants {
    ...
    public static final String PROP_BLOGGERID = "blog:bloggerid";
    public static final String PROP_DATE = "blog:date";
    public static final String PROP_SUMMARY = "blog:summary";
    public static final String PROP_TITLE = "blog:title";
}
