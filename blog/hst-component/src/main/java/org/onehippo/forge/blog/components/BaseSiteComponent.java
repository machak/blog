...
import org.onehippo.forge.blog.beans.BaseDocument;
import org.onehippo.forge.blog.beans.Blogpost;
import org.onehippo.forge.blog.beans.CommentBean;
import org.onehippo.forge.blog.beans.CommentLinkBean;
...
public class BaseSiteComponent extends BaseHstComponent {
    ...
    static {
        ...
        classes.add(TextDocument.class);
        classes.add(Blogpost.class);
        classes.add(CommentLinkBean.class);
